...
- Use the bundled `pdf2zh/` core. Never substitute the PyPI `pdf2zh` package; the runner checks version `2.1.0` and preservation ruleset `code4life-preservation-v1` and refuses an external core.

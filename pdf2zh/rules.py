...
FORMULA_FONT_PATTERN = re.compile(
    r"(^(CM[^R]|MS.M|XY|MTCode|MTMath|BL|EU|LA|RS|TeX|rsfs|txsy|wasy|stmary)|"
    r"Math|Symbol|StandardSym|MathJax|Asana|STIX|CambriaMath|.*Mono|.*Code|Consolas|Courier|Menlo|Monaco|Inconsolata|Source.?Code|Fira.?Code)",
    re.IGNORECASE,
)
...
def is_formula_font(font_name: str) -> bool:
    ...
    return FORMULA_FONT_PATTERN.search(font_name) is not None
